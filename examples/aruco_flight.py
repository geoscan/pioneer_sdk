    ...
    while True:
        ...
        try:
            ...
            if np.all(ids is not None):
                ...
                x_center = int((corners[0][0][0][0] + corners[0][0][1][0] \
                               + corners[0][0][2][0] + corners[0][0][3][0])
                               // 4)
                y_center = int((corners[0][0][0][1] + corners[0][0][1][1]
        ...
        if coordinates is not None:
            ...
            distance = np.sqrt(coordinates[0]**2 + coordinates[1]**2
                               + coordinates[2]**2)
            ...
            if v_y != 0 or yaw_rate != 0:
                mini.set_manual_speed_body_fixed(vx=0, vy=v_y, vz=0,
                                                 yaw_rate=yaw_rate)
